...
- **Key dependencies**: tokio for async, serde for serialization
- **Target platforms**: Linux across diverse processors (x86_64, ARM64, ARMv7, ARMv8, RISC-V)
- **Cross-platform**: Aim for portability across operating systems where feasible (Linux, macOS, Windows)
...
- **Error handling**: Result types with custom error enum
...
Example:
- Inference latency: < 50ms for standard models
- Memory footprint: < 512MB for typical workload
- Startup time: < 2 seconds
- Power consumption: < 5W average for vision processing
...
Example:
- NPU support: Qualcomm Hexagon DSP, NXP i.MX8
- GPU acceleration: CUDA 11+, OpenCL 2.0+
- Camera interfaces: V4L2, MIPI CSI-2
- Platform quirks: Document SoC-specific behaviors
...
- Fixtures: Place in `tests/common/` module

Example for Python project:
- Framework: pytest (or unittest - specify which)
