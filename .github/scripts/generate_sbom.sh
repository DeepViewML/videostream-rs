...
echo "=================================================="
echo "Generating Complete SBOM for videostream-rs"
echo "=================================================="
echo
...
echo "✓ Generated videostream.cdx.json (Rust dependencies)"
echo
...
# Scan source directories for license/copyright information
venv/bin/scancode -clpieu \
    --cyclonedx source-sbom-raw.json \
    --only-findings \
    src/ videostream-sys/src/ videostream-sys/build.rs Cargo.toml videostream-sys/Cargo.toml
...
cyclonedx merge \
    --input-files videostream.cdx.json source-sbom.json \
...
rm -f source-sbom-raw.json source-sbom.json videostream.cdx.json
